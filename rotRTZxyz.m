function [R SH ba] = rotRTZxyz(x,y,z,station,cluster)

%
% [R SH ba] = rotRTZxyz(x,y,z,station,cluster)
%
% rotRTZ       rotates the lpx, lpy and lpz signals into the radial (R) and 
%              tranverses (SH & SV) components. t is time vector.
%              x y z are the original signals. ba is back-azimuth.
%
%
% 
